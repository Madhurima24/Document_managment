    ...
    try {
      ...
      if (result != null && result.files.isNotEmpty) {
        List<FileItemNew> fileList =
            processFiles(result.files, isFolderUpload, folderName, processId);
        ...
        //   };
        //   index++;
        //    IKonService.iKonService.startProcessV2(processId: processId, data: extractData, processIdentifierFields: null);
